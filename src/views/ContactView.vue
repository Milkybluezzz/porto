    ...
    <section class="contact fade-zoom-out">
      <div class="container">
        ...
        <div class="social-links">
          <a href="https://wa.me/+6287787075537" target="_blank" class="social-icon">
            <i class="fab fa-whatsapp"></i>
          </a>
          <a href="https://www.instagram.com/radithiaannafi/" target="_blank" class="social-icon">
            <i class="fab fa-instagram"></i>
          </a>
          <a href="https://www.linkedin.com/in/radithia-annafi-083882247/" target="_blank" class="social-icon">
