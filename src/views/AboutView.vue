    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 7,
          name: 'Laravel',
          imageUrl: 'https://img.icons8.com/?size=96&id=lRjcvhvtR81o&format=png',
          status: 'Beginner'
        },
        {
          id: 8,
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="/img/profile2.jpeg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp;    Hai semuanya! Nama saya Radithia Annafi. Saya adalah seorang Pengembang Web Front-End Pemula dari Bandung, Indonesia.
            Dengan pengalaman dua tahun dalam pengembangan situs web di Sekolah Menegah Kejuruan Negri 4 Bandung. Saya sangat menikmati apa yang saya lakukan. 
            Menurut saya, membuat program bukan hanya sekedar pekerjaan tapi juga sebuah seni yang memiliki nilai estetika.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp;   Membangun situs web yang fungsional, mudah digunakan, dan menarik secara visual lebih dari sekadar pekerjaan bagi saya - ini adalah hobi dan gairah saya. 
            Saya senang menambahkan sentuhan pribadi pada setiap proyek untuk memastikan bahwa setiap situs web tidak hanya menonjol tetapi juga menawarkan pengalaman pengguna yang mudah. 
            Saya bersemangat untuk terus memberikan yang terbaik kepada klien di masa depan, mewujudkan visi mereka dengan cara yang paling kreatif dan efektif.
          </p>
        </div>
